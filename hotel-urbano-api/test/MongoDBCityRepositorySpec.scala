...
class MongoDBCityRepositorySpec extends BaseSpec with BeforeAndAfterEach with ScalaFutures {
  ...
  val city1 = City(UUID.fromString("a4065490-8cda-45e4-b42c-ff8f7f792ef4"), "Rio de Janeiro, Rio de Janeiro Estado, Regiao Sudeste, Brasil")
  val city2 = City(UUID.fromString("c7e6baaf-2812-4e3b-8f29-1c489ceadc15"), "Fortaleza, Ceara, Regiao Nordeste, Brasil")
  val city3 = City(UUID.fromString("bc587e57-fe83-4ad9-98a9-7bbf0b930a5c"), "Porto Alegre, Rio Grande do Sul, Regiao Sul, Brasil")
  val city4 = City(UUID.fromString("bc587e57-fe83-4ad9-98a9-333333333333"), "Berlim, Alemanha")
